...
const FacebookIcon = () => (
  <svg viewBox="0 0 24 24" className="size-5">
    <path
      fill="currentColor"
      d="M22.675 0H1.325C.593 0 0 .593 0 1.325v21.351C0 23.407.593 24 1.325 24h11.493v-9.294H9.689V11.2h3.129V8.211c0-3.124 1.868-4.831 4.75-4.831 1.38 0 2.839.102 3.065.148v3.577h-2.108c-1.651 0-2.053.786-2.053 2.001v2.623h4.106l-.53 3.506h-3.576v9.294h7.028c.732 0 1.325-.593 1.325-1.325V1.325C24 .593 23.407 0 22.675 0z"
    />
  </svg>
);
